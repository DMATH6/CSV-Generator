...
public class GenerateCSV {
	...
	public static void main(String[] args) {
		...
		ArrayList<String> rowdata = coldata;
		Scanner forthopscnr = new Scanner(System.in);;
		while (sixoploop <= customrownum)
		{
			...
			op4p1:
				try {
					int forthoploop = 0;
					 ...
					 //Having issues trying to close it
					for(forthoploop = 0; forthoploop <= customcolnum;forthoploop++){
					...
					rowdata.add(coldata.get(sixoploop));
					sixoploop++;
